...
import com.cjc.controller.EnquiryHomecontroller;
import java.io.*;
import java.sql.*;
...
//	@PostMapping("cust/{cid}")
//	public void savecust(@PathVariable int cid) {
//		Enquiry u=usi.getSingledata1(cid);
//		System.out.println(u.getCid());
//			Customer c=new Customer();
//			c.setCustomerName(u.getCustomerName());
//			c.setCustomerId(u.getCid());
//			c.setCustomerDateOfBirth(u.getCustomerDateOfBirth());
//			c.setCustomerAge(u.getCustomerAge());
//			c.setCustomerEmail(u.getCustomerEmail());
//			c.setCustomerGender(u.getCustomerGender());	Customer u2= usi.savecostmer(c);
//		
//		
//	}
...
//}
	...
	public ResponseEntity< CustomerDocuments> getDocumentByCusId(@PathVariable Integer customerId) throws CustomerIdNotFoundException {
		 CustomerDocuments document = usi.getCustomerDocuments(customerId);
		return new ResponseEntity<>(document, HttpStatus.OK);				
	}
	@GetMapping("/changeStatus/{customerId}")
	public String changeStatus(@PathVariable Integer customerId) throws CustomerNotFoundException {
