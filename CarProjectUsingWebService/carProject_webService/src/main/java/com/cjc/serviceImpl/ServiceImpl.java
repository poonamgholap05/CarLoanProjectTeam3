...
@Override
public CustomerDocuments getCustomerDocuments(Integer customerId) throws CustomerIdNotFoundException  {
...
@Override
public boolean changeStatus(Integer customerId) throws CustomerNotFoundException{
